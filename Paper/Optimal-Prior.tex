...
% Titles:
% (1) Improving Small Sample Performance of the Generalized Cross 
% Entropy Estimator
% (1) Introducing a Complete Set of Potential Priors for Improving Performance: 
% An Information-Theoretic Approach
% (2) Identifying Prior Information to Improve Small Sample Performance: An
% Information-Theoretic Approach
% (3) An Information-Theoretic Approach to Identifying Prior Information
% (4) An Information-Theoretic Estimator with Divergence-Minimizing Prior
% (5) The Generalized Cross Entropy Estimator with Divergence-Minimizing Prior
% (6) Informational Divergence as a Prior Selection Criterion
...
% III. DM-GCE estimator (350 words) (~391 currently and checked) 
% IV. Sampling Experiments (450 words) (~353 currently and checked) 
% V. Results and Discussion (500 words) (~551 currently and checked)

% Ask Amos:
% Title
% Capitalize or lower-case IT, GME, and GCE
% DM-GCE?
% Word count (can't include much more)
...
Experiment & \multicolumn{1}{c}{DM-GCE} & 
\multicolumn{1}{c}{GME} &
...
%Once again, the DM-GCE estimator (i.e.\ prior ``6'') outperforms the 
...
%relative to OLS. 
%Further, the DM-GCE estimator leads to precision risk reduction of 
...
%that GME continues to outperform OLS and DM-GCE generally outperforms
%GME. 
%While in experiment 11 the performances of DM-GCE and GME are indeed
...
%non-negligible reductions in the ill-conditioned case (e.g.\ DM-GCE witnessed 
...
%While DM-GCE continued to outperform GME in this case, OLS outperformed 
