...
% Word target: 2,000 words (~ 2,081 currently)

% Outline:
% I. Introduction (~459 currently and checked)
% II. GCE estimator (~385 currently and checked)
% III. MP-GCE estimator (~405 currently and checked) 
% IV. Sampling Experiments (~327 currently and checked) 
% V. Results (500 words) (~412 currently and checked) 
% VI. Conclusions (~93 currently and checked)
...
% HH: If all properties are known, then why do it?
